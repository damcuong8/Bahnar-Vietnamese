...
from utils import StandardLayerNorm, BatchLayout
...
class Wav2Vec2Frontend(nn.Module):
    ...
    def __init__(
        ...
        model_dim: int,
        feature_dim: int,
        feature_extractor: SeamlessM4TFeatureExtractor | None,
        ...
        *,
        ...
        self.model_dim_proj: Linear | None
        ...
        self.first_pass_dropout: Dropout | None

        self.register_module("first_pass_dropout", first_pass_dropout)

        self.pos_encoder: nn.Module | None
    ...
    def forward(
        ...
        seqs, temporal_mask = self.process_features(seqs, seqs_layout, masker)

        return seqs, seqs_layout, temporal_mask
    ...
    def process_features(
        ...
        :returns:
            - The processed features to pass to the resolver network. *Shape:*
